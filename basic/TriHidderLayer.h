...
public:
  ...
  inline void initial(Tensor<xpu, 2, double> W1, Tensor<xpu, 2, double> W2, Tensor<xpu, 2, double> W3, Tensor<xpu, 2, double> b, bool bUseB = true,
      int funcType = 0) {
...
public:
  inline void ComputeForwardScore(Tensor<xpu, 2, double> x1, Tensor<xpu, 2, double> x2, Tensor<xpu, 2, double> x3, Tensor<xpu, 2, double> y) {
    y = dot(x1, _W1.T());
    y += dot(x2, _W2.T());
    y += dot(x3, _W3.T());
    if (_bUseB)
  ...
  inline void ComputeBackwardLoss(Tensor<xpu, 2, double> x1, Tensor<xpu, 2, double> x2, Tensor<xpu, 2, double> x3, Tensor<xpu, 2, double> y,
      Tensor<xpu, 2, double> ly, Tensor<xpu, 2, double> lx1, Tensor<xpu, 2, double> lx2, Tensor<xpu, 2, double> lx3) {
    //_gradW
