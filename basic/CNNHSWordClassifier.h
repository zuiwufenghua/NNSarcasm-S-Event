...
public:
  ...
  inline void init(const NRMat<double>& wordEmb, const NRMat<double>& wordhEmb, int wordcontext, int labelSize, int wordHiddenSize, int hiddenSize) {
  ...
  inline double process(const vector<Example>& examples, int iter) {
    _eval.reset();
    _word_indexers.clear(); _wordh_indexers.clear();
