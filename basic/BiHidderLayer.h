...
public:
  ...
  inline void initial(Tensor<xpu, 2, double> WL, Tensor<xpu, 2, double> WR, Tensor<xpu, 2, double> b, bool bUseB = true, int funcType = 0) {
...
public:
  inline void ComputeForwardScore(Tensor<xpu, 2, double> xl, Tensor<xpu, 2, double> xr, Tensor<xpu, 2, double> y) {
    y = dot(xl, _WL.T());
    y += dot(xr, _WR.T());
    if (_bUseB)
      y = y + _b;
  ...
  inline void ComputeBackwardLoss(Tensor<xpu, 2, double> xl, Tensor<xpu, 2, double> xr, Tensor<xpu, 2, double> y, Tensor<xpu, 2, double> ly,
